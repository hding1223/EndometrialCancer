...
write.table(GO, file="IRG_GO.txt", sep="\t", quote=F, row.names = F)
...
#??״ͼ
pdf(file="IRG_GO_barplot.pdf", width=9, height=12)
...
#????ͼ
pdf(file="IRG_GO_bubble.pdf", width=9, height=12)
...
pdf("IRG_GO_circlize.pdf",width=10,height=10)
